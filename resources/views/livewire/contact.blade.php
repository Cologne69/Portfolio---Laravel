<div class="h-screen grid content-center">
    ...
    <div class="toast hidden toast-top toast-center w-max" id="toastDiscord">
        <div class="alert bg-secondary">
            <div>
                <span>{{ __('Discord tag is copied!') }}</span>
            </div>
        </div>
    </div>
    <div class="grid sm:grid-cols-1 md:grid-cols-2">
            ...
            <div class="card mr-1">
                <div style="card-body">
                    <div class="grid gap-2 justify-items-end">
                        <a href="https://github.com/colognex" target="_blank"
                            class="btn gap-2 btn-primary w-auto h-auto animate__animated animate__fadeInLeft">
                        ...
                        <br>
                        <a href="https://www.instagram.com/kyrelllsaw/" target="_blank"
                            class="btn gap-2 btn-primary w-auto h-auto animate__animated animate__fadeInLeft"
                            style="animation-delay:0.4s">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" id="instagram"
                                fill="currentColor" class="h-8 w-8">
                                <path
                        ...
                        <br>
                        <a href="https://wa.link/gxi4jg" target="_blank"
                            class="btn gap-2 btn-primary w-auto h-auto animate__animated animate__fadeInLeft"
                            style="animation-delay:0.8s">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="mobile" class="h-8 w-8"
                                fill="currentColor">
                                <path
                        ...
                        <br />
                        <a href="https://www.youtube.com/channel/UCgavt_hghvbQmMl3mWeCQTA" target="_blank"
                            class="btn gap-2 btn-primary w-auto h-auto animate__animated animate__fadeInLeft"
                            style="animation-delay:1.2s">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                                class="h-8 w-8" id="youtube">
                                <path
                ...
                <div style="card-body">
                    <div class="my-3">
                        <div class="grid gap-2 justify-items-start">
                            <br>
                            <a href="https://www.linkedin.com/in/kyrellsiauw/" target="_blank"
                                class="btn gap-2 btn-primary w-auto h-auto animate__animated animate__fadeInRight"
                            ...
                            <a onclick="copyContent()"
                                class="btn gap-2 btn-primary w-auto h-auto animate__animated  animate__fadeInRight"
                                style="animation-delay:0.6s" data-tip="Content has been copied!">
                            ...
                            <br>
                            <a href="mailto:kyrellsiauw204@gmail.com" target="_blank"
                                class="btn gap-2 btn-primary w-auto h-auto animate__animated animate__fadeInRight"
        ...
        <script>
            const copyContent = async () => {
                const toast = document.getElementById("toastDiscord");
                toast.classList.remove("hidden");
                setTimeout(() => {
                    toast.classList.add("hidden");
                }, 3000);
                try {
                    await navigator.clipboard.writeText("CologneSUS#0601");
                    toast.show();
                } catch (err) {
